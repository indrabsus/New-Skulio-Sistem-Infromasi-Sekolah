@if ($hitung == 0)
    <h1>Anda Bukan Walikelas</h1>
@else
@if (strpos(Config::get('guru'), Auth::user()->level) === false)
<script>window.location = "{{ route('index') }}";</script>
@endif
<div>
    <div class="mb-3"><h3>Walikelas {{ strtoupper($kelas->nama_kelas) }}</h3></div>
    <div class="row">
        <div class="col-lg-2 mb-1"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add">
            Tambah Siswa
          </button></div>
        ...
        <div class="col-lg-3 mb-1">
            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#note">Lihat Catatan Siswa</button>
        </div>
    </div>
    ...
    @endif
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                     <button type="button" class="btn btn-dark btn-sm mb-1" data-toggle="modal" data-target="#reset" wire:click="creset({{$d->id}})">
                        Reset
                      </button> <button class="btn btn-success btn-sm mb-1" wire:click="edit({{$d->id}})" data-toggle="modal" data-target="#edit">Edit</button> <button class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#delete" wire:click="konfirmasiHapus({{$d->id}})">Delete</button>
                </td>
            </tr>
            @endforeach
        </tbody>
                    ...
                    <div class="container">
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach ($catatan as $c)
                                ...
                                @endif
                                    <td>{{ $c->nama_siswa }}</td>
                                    <td>{{ $c->keterangan }} {{ $c->kelakuan == 'baik'?'+':'-' }}{{ $c->kpoin }}</td>
                                </tr>
