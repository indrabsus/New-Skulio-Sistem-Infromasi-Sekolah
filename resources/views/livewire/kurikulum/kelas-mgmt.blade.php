    ...
    @endif
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $d->nama_kelas }}</td>
                <td>{{ $d->nama_guru }}</td>
                <td><button class="btn btn-success btn-sm mb-1" wire:click="edit({{$d->id_kelas}})" data-toggle="modal" data-target="#edit">Edit</button> <button class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#delete" wire:click="konfirmasiHapus({{$d->id_kelas}})">Delete</button></td>
            </tr>
            @endforeach
        </tbody>
        </table>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Kelas</label>
                            <select class="custom-select form-control-border" wire:model="id_kelas" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control-border" wire:model="id_guru">
          ...
          <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Kelas</label>
                        <input type="text" class="form-control" wire:model="nama_kelas">
                        <div class="text-danger">
                            @error('nama_kelas')
                                {{$message}}
                            @enderror
