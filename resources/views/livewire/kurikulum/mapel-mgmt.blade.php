    ...
    @endif
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $no++ }}</td>
                <td>{{ $d->nama_mapel }}</td>
                <td><button class="btn btn-success btn-sm mb-1" wire:click="edit({{$d->id_mapel}})" data-toggle="modal" data-target="#edit">Edit</button> <button class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#delete" wire:click="konfirmasiHapus({{$d->id_mapel}})">Delete</button></td>
            </tr>
            @endforeach
        </tbody>
        </table>
