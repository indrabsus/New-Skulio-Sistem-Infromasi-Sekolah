              ...
              <div class="container">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" wire:model="nama_menu">
                    ...
                    <div class="form-group">
                        <label>Path</label>
                        <input type="text" class="form-control" wire:model="path">
                        <div class="text-danger">
                            @error('path')
                                {{$message}}
                            @enderror
                    ...
                    <div class="form-group">
                        <label>Route</label>
                        <input type="text" class="form-control" wire:model="route">
                        <div class="text-danger">
                            @error('route')
                                {{$message}}
                            @enderror
