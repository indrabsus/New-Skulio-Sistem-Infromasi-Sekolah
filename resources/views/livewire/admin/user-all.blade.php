...
@endif
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $d->username }}</td>
            <td>{{ $d->level }}</td>
            <td><button class="btn btn-success btn-sm mb-1" wire:click="edit({{$d->id}})" data-toggle="modal" data-target="#edit">Edit</button> <button class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#delete" wire:click="konfirmasiHapus({{$d->id}})">Delete</button></td>
        </tr>
        @endforeach
    </tbody>
    </table>
